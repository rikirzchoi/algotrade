...
export function Sidebar() {
  ...
  return (
    <aside
      className="fixed inset-y-0 left-0 w-[220px] flex flex-col bg-[#111113]
                 border-r border-border z-40"
    >
      {/* Logo */}
        ...
        <div className="mt-1 flex items-center gap-1.5">
          <span
            className={cn(
              ...
              wsConnected ? 'bg-positive animate-pulse' : 'bg-negative',
            )}
          />
          ...
          {isHalted && (
            <span className="badge badge-red text-[9px] ml-1">HALTED</span>
          )}
        </div>
      </div>
        ...
        <div className="flex items-center justify-between px-1 mb-1">
          ...
          <span
            className={cn(
              ...
              isPaper ? 'bg-positive' : 'bg-negative',
            )}
          />
        </div>
